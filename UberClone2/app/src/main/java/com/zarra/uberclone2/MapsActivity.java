...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnLogoutPsg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    if(objects.size()>0 && e==null){
                        ...
                        for(ParseObject request:objects){
                            request.deleteInBackground(new DeleteCallback() {
                                ...
                                public void done(ParseException e) {
                                    if(e==null){
                                        Toast.makeText(MapsActivity.this,"Request deleted",Toast.LENGTH_SHORT).show();
                                        isCarReady=false;
                                    }
                                }
                            });
    ...
    private void getDriverUpdates(){
        ...
        t.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                uberRequestQuery.whereExists("driver");
                    ...
                    public void done(List<ParseObject> objects, ParseException e) {
                        if(objects.size()>0 && e==null){
                            for(ParseObject object:objects){
                                ...
                                driverQuery.whereEqualTo("username",object.get("driver"));
                                    ...
                                    public void done(List<ParseUser> objects, ParseException e) {
                                        if(objects.size()>0 && e==null){
                                            ...
                                            for (ParseUser user:objects){
                                                ParseGeoPoint driverLocation=user.getParseGeoPoint("driverLocation");
                                                if(ContextCompat.checkSelfPermission(MapsActivity.this,Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
                                                    ...
                                                    double milesDistance=driverLocation.distanceInMilesTo(parseGeoPoint);
                                                    ...
                                                    if(milesDistance<0.3){
                                                        ...
                                                        object.deleteInBackground(new DeleteCallback() {
                                                            @Override
                                                            public void done(ParseException e) {
                                                                Toast.makeText(MapsActivity.this,"Your Uber is ready!",Toast.LENGTH_SHORT).show();
                                                                isCarReady=false;
                                                                isUberCancelled=true;
                                                                btnRequestCar.setText("Order a new Uber");
                                                        ...
                                                        Toast.makeText(MapsActivity.this, object.get("driver").toString() + " is " + roundedDistance + " miles away from you", Toast.LENGTH_SHORT).show();

                                                        LatLng dLocation = new LatLng(driverLocation.getLatitude(), driverLocation.getLongitude());
