...
/**
 * Created by mragl on 26.11.2016.
 */

public class FastScroller extends LinearLayout {
    private View handle,bubble;
    ...
    private void initialize(Context context){
        ...
        View v=inflater.inflate(R.layout.fastscroller,this);
        handle=v.findViewById(R.id.fastscroller_handle);
        bubble=v.findViewById(R.id.fastscroller_bubble);
    }
    ...
    private void showHandle(){
        ...
        animationSet.playTogether(growerX, growerY, alpha);
        animationSet.start();
